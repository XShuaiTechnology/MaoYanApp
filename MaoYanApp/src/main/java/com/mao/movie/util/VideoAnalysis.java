...
import com.mao.movie.model.XDYY;
    ...
    public static Map<String, Object> getVideoPath(String url, Context context) {
        ...
        if (TextUtils.isEmpty(App.getInstance().analysisUrl)) {
            ...
            if (!TextUtils.isEmpty(url)) {
                ...
                String finalUrl = "";
                if (urls.length == 1) {
                    finalUrl = App.getInstance().analysisUrl + ANALYSIS_HEAD + "&url=" + url;
                } else if (urls.length == 2) {
                    String str = urls[1];
                    finalUrl = App.getInstance().analysisUrl + ANALYSIS_HEAD + "&type=" + urls[0];
